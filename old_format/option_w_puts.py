...
class Option:
    ...
    """
    Functions, which are necessary to compute price of the european option for given parameters.
    as mentioned in  https://doi.org/10.1016/j.ejor.2017.05.018 equations 14, 15a, 15b, 15c, 15d, 11a, 11b, 11c.  
    """
    def ksi(self, u):
    ...
    def char_function(self, u, t, S_0, r):
        """
        Retourne la fn charactéristique equation (18)
        =============================
        Input:
        T : Maturité
        S_0 : Prix du sous-jacent
        r : Taux d'intérêt 
        u : parametre de la fonction caracteristique
        =============================
        Output: integral value (real part of complex number)
        """
    ...
    def integrate_char_function(self, K, t, S_0, r, i):
        """
        Retourne les integrales de la fn charactéristique par Gauss-Legendre https://doi.org/10.1016/j.ejor.2017.05.018
        =============================
        Input:
        K : Strike 
        T : Maturité
        S_0 : Prix du sous-jacent
        r : Taux d'intérêt 
        i : imaginary number i if passed 1j else we use 0
        =============================
        Output: integral value (real part of complex number)
        """
    ...
    def HestonPrice(self,S,K, T, r=0.0, CallPutFlag = 'C'):
        """
        Retourne le prix Heston equation (9) https://doi.org/10.1016/j.ejor.2017.05.018
        =============================
        Input: CallPutFlag : call ou put
        K : Strike 
        T : Maturité
        S : Prix du sous-jacent
        r : Taux d'intérêt 
        =============================
        Output: Heston price (float)
        """
        if CallPutFlag == 'C':
            return 1/S *( 
    ...
    """
    fonctions nécessaire pour le calcul de la fonction charactersique (22, 23a, 23b, 23c, 23d, 23e ) 
    (27a), (27b), (27c), (27d), (27e), (28a), (28b), (29), (30a), (30b), (30c) 
    dans https://doi.org/10.1016/j.ejor.2017.05.018
    """
    def h_1(self, u, t):
    ...
    def integrate_grad_function(self, K, t, S_0, r, i, which):
        """
        Retourne les integrales calculés par Gauss-Legendre Algorithm 3.1 https://doi.org/10.1016/j.ejor.2017.05.018
        =============================
        Input: Parameters vector theta
        K : Strike 
        T : Maturité
        S_0 : Prix du sous-jacent
        r : Taux d'intérêt 
        M : Nombre des points dans le grod
        deg : degree du polynome de Legendre-Gauss
        =============================
    ...
    def grad_heston_price(self, t, K, S_0, r):
        """
        Retourne le gradient du prix de Heston suivant l'équation (22) de https://doi.org/10.1016/j.ejor.2017.05.018
        =============================
        Input: Parameters vector theta
        K : Strike 
        T : Maturité
    ...
    def target_f_heston(self, x):
        """
        Fonction des résidus à minimiser lors de la recherche des paramètres optimaux pour le modèle de Heston.
        ==================
        Input:  x  : liste [m, v, lam] des 3 paramètres à optimiser.
        ==================
        Output: Vecteur normalisé de la différence des prix sous le modèle de Merton calibré avec x et les prix du marché.
    ...
    def optimize_heston(self, x):
        """
        Retourne le vecteur des parametres optimaux par optimisation en utilisant Levenberg–Marquardt Algorithm 4.1 
        ou SLSQP
        =============================
        Input: Parameters vector theta_0
        =============================
        Output: Theta (Vector)
        """
